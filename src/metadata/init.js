...
get сutting(){return this._getter_ts('сutting')}
set сutting(v){this._setter_ts('сutting',v)}
}
...
class DocWork_centers_taskСuttingRow extends TabularSectionRow{
get production(){return this._getter('production')}
set production(v){this._setter('production',v)}
get specimen(){return this._getter('specimen')}
set specimen(v){this._setter('specimen',v)}
...
$p.DocWork_centers_taskСuttingRow = DocWork_centers_taskСuttingRow;
