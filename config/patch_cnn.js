...
export const predefined = {
  ...
  'ecookna.': {zone: 21, host: "https://zakaz.ecookna.ru/", splash: {img: '', text: ''}, log_level: 'warn', templates: true},
  //'localhost': {zone: 21, splash: {img: '', text: ''}, log_level: 'warn', templates: true},
