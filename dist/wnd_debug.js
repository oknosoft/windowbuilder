...
function CatScheme_settingsAvailable_fieldsRow(owner){CatScheme_settingsAvailable_fieldsRow.superclass.constructor.call(this, owner)};
CatScheme_settingsAvailable_fieldsRow._extend($p.TabularSectionRow);
$p.CatScheme_settingsAvailable_fieldsRow = CatScheme_settingsAvailable_fieldsRow;
CatScheme_settingsAvailable_fieldsRow.prototype.__define({parent: {get: function(){return this._getter('parent')}, set: function(v){this._setter('parent',v)}, enumerable: true, configurable: true},
...
caption: {get: function(){return this._getter('caption')}, set: function(v){this._setter('caption',v)}, enumerable: true, configurable: true}});
CatScheme_settings.prototype.__define('available_fields', {get: function(){return this._getter_ts('available_fields')}, set: function(v){this._setter_ts('available_fields',v)}, enumerable: true, configurable: true});
function CatScheme_settingsSort_fieldsRow(owner){CatScheme_settingsSort_fieldsRow.superclass.constructor.call(this, owner)};
CatScheme_settingsSort_fieldsRow._extend($p.TabularSectionRow);
$p.CatScheme_settingsSort_fieldsRow = CatScheme_settingsSort_fieldsRow;
CatScheme_settingsSort_fieldsRow.prototype.__define({parent: {get: function(){return this._getter('parent')}, set: function(v){this._setter('parent',v)}, enumerable: true, configurable: true},
field: {get: function(){return this._getter('field')}, set: function(v){this._setter('field',v)}, enumerable: true, configurable: true},
...
CatScheme_settings.prototype.__define('sort_fields', {get: function(){return this._getter_ts('sort_fields')}, set: function(v){this._setter_ts('sort_fields',v)}, enumerable: true, configurable: true});
function CatScheme_settingsGrouping_fieldsRow(owner){CatScheme_settingsGrouping_fieldsRow.superclass.constructor.call(this, owner)};
CatScheme_settingsGrouping_fieldsRow._extend($p.TabularSectionRow);
$p.CatScheme_settingsGrouping_fieldsRow = CatScheme_settingsGrouping_fieldsRow;
CatScheme_settingsGrouping_fieldsRow.prototype.__define({parent: {get: function(){return this._getter('parent')}, set: function(v){this._setter('parent',v)}, enumerable: true, configurable: true},
field: {get: function(){return this._getter('field')}, set: function(v){this._setter('field',v)}, enumerable: true, configurable: true}});
CatScheme_settings.prototype.__define('grouping_fields', {get: function(){return this._getter_ts('grouping_fields')}, set: function(v){this._setter_ts('grouping_fields',v)}, enumerable: true, configurable: true});
...
function CatScheme_settingsSchemeRow(owner){CatScheme_settingsSchemeRow.superclass.constructor.call(this, owner)};
CatScheme_settingsSchemeRow._extend($p.TabularSectionRow);
$p.CatScheme_settingsSchemeRow = CatScheme_settingsSchemeRow;
CatScheme_settingsSchemeRow.prototype.__define({parent: {get: function(){return this._getter('parent')}, set: function(v){this._setter('parent',v)}, enumerable: true, configurable: true},
kind: {get: function(){return this._getter('kind')}, set: function(v){this._setter('kind',v)}, enumerable: true, configurable: true}});
CatScheme_settings.prototype.__define('scheme', {get: function(){return this._getter_ts('scheme')}, set: function(v){this._setter_ts('scheme',v)}, enumerable: true, configurable: true});
...
CatWork_center_kinds.prototype.__define({predefined_name: {get: function(){return this._getter('predefined_name')}, set: function(v){this._setter('predefined_name',v)}, enumerable: true, configurable: true},
parent: {get: function(){return this._getter('parent')}, set: function(v){this._setter('parent',v)}, enumerable: true, configurable: true}});
...
DocWork_centers_task.prototype.__define({key: {get: function(){return this._getter('key')}, set: function(v){this._setter('key',v)}, enumerable: true, configurable: true},
...
function DocWork_centers_taskПотребностьИтогRow(owner){DocWork_centers_taskПотребностьИтогRow.superclass.constructor.call(this, owner)};
DocWork_centers_taskПотребностьИтогRow._extend($p.TabularSectionRow);
$p.DocWork_centers_taskПотребностьИтогRow = DocWork_centers_taskПотребностьИтогRow;
DocWork_centers_taskПотребностьИтогRow.prototype.__define({nom: {get: function(){return this._getter('nom')}, set: function(v){this._setter('nom',v)}, enumerable: true, configurable: true},
characteristic: {get: function(){return this._getter('characteristic')}, set: function(v){this._setter('characteristic',v)}, enumerable: true, configurable: true},
...
DocWork_centers_task.prototype.__define('ПотребностьИтог', {get: function(){return this._getter_ts('ПотребностьИтог')}, set: function(v){this._setter_ts('ПотребностьИтог',v)}, enumerable: true, configurable: true});
function DocWork_centers_taskОбрезьВходRow(owner){DocWork_centers_taskОбрезьВходRow.superclass.constructor.call(this, owner)};
DocWork_centers_taskОбрезьВходRow._extend($p.TabularSectionRow);
$p.DocWork_centers_taskОбрезьВходRow = DocWork_centers_taskОбрезьВходRow;
DocWork_centers_taskОбрезьВходRow.prototype.__define({Хлыст: {get: function(){return this._getter('Хлыст')}, set: function(v){this._setter('Хлыст',v)}, enumerable: true, configurable: true},
...
DocWork_centers_task.prototype.__define('ОбрезьВход', {get: function(){return this._getter_ts('ОбрезьВход')}, set: function(v){this._setter_ts('ОбрезьВход',v)}, enumerable: true, configurable: true});
function DocWork_centers_taskОбрезьВыходRow(owner){DocWork_centers_taskОбрезьВыходRow.superclass.constructor.call(this, owner)};
DocWork_centers_taskОбрезьВыходRow._extend($p.TabularSectionRow);
$p.DocWork_centers_taskОбрезьВыходRow = DocWork_centers_taskОбрезьВыходRow;
DocWork_centers_taskОбрезьВыходRow.prototype.__define({Хлыст: {get: function(){return this._getter('Хлыст')}, set: function(v){this._setter('Хлыст',v)}, enumerable: true, configurable: true},
len: {get: function(){return this._getter('len')}, set: function(v){this._setter('len',v)}, enumerable: true, configurable: true},
width: {get: function(){return this._getter('width')}, set: function(v){this._setter('width',v)}, enumerable: true, configurable: true},
...
ЯчейкаНов: {get: function(){return this._getter('ЯчейкаНов')}, set: function(v){this._setter('ЯчейкаНов',v)}, enumerable: true, configurable: true}});
DocWork_centers_task.prototype.__define('ОбрезьВыход', {get: function(){return this._getter_ts('ОбрезьВыход')}, set: function(v){this._setter_ts('ОбрезьВыход',v)}, enumerable: true, configurable: true});
...
DocCalc_orderPlanningRow.prototype.__define({date: {get: function(){return this._getter('date')}, set: function(v){this._setter('date',v)}, enumerable: true, configurable: true},
...
RepMaterials_demandProductionRow.prototype.__define({characteristic: {get: function(){return this._getter('characteristic')}, set: function(v){this._setter('characteristic',v)}, enumerable: true, configurable: true},
qty: {get: function(){return this._getter('qty')}, set: function(v){this._setter('qty',v)}, enumerable: true, configurable: true}});
