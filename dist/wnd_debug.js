...
$p.modifiers.push(
	function($p){
		...
		_mgr.sql_selection_list_flds = function(initial_value){
			return "SELECT _t_.ref, _t_.`deleted`, _t_.is_folder, case when _t_.is_folder = '' then _t_.id || _p_.name || _t_.name else _t_.name end as presentation, _t_.svg," +
